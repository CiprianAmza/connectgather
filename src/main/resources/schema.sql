...
DROP TABLE IF EXISTS organizers; -- NOU: Șterge tabelul organizers
...
CREATE TABLE events (
    ...
    organizer_id BIGINT NOT NULL, -- NOU: Acum referă organizers.id
    CONSTRAINT fk_event_location FOREIGN KEY (location_id) REFERENCES locations (id),
    CONSTRAINT fk_event_organizer FOREIGN KEY (organizer_id) REFERENCES organizers (id) -- NOU: Cheie externă către organizers
);
